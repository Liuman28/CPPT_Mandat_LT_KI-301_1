    ...
    public void callTO(String phoneNumber) {
        ...
        if (isValid(phoneNumber)) {
            ...
            if (Bat.getBatteryCharge() >= 0) {
                ...
                System.out.println("Your call was in progress " +
                        (time2 - time1) / 1000 + " seconds");
                Bat.setBatteryCharge((int) (Bat.getBatteryCharge() -
                        (time2 - time1) / 30000));
...
class Battery {
    ...
    /**
     * Method set Battery Charge value in
     range[Min_BatteryCharge,Max_BatteryCharge]
     *
     * @param num the Battery Charge value
     */
...
class VolButton {
    ...
    /**
     * Method Simulate increasing Volume by 1 in
    ...
    /**
     * Method Simulate decreasing Volume by 1 in
     range[Min_Volume,Max_Volume]
     */
    public void ClickDownButton() {
